 ...
 * irq.h   v1.0
 *
 * This module contains all addresses of all registers 
 * to work with GIC400 (Raspberry pi 4b) interruption controller
 *
 * T.Kuz    11.2024
 */
#ifndef _IRQ_H
...
/* we are using Physical to Virtual convertation here because 
 * this module will be started after enabling MMU */
